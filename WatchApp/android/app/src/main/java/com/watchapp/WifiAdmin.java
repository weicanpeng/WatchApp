...
public class WifiAdmin {
    ...
    public void addNetwork(String ssid, String passwd, int type) {
        ...
        if (type != TYPE_WEP && type != TYPE_WPA) {
...
//                Log.e("ggf", "return existingConfig" + existingConfig.SSID);
